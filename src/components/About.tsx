...
const About = () => {
  return (
    <section id="about" className="py-16 md:py-24 px-4 sm:px-6 bg-secondary/50">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-8 mb-8 md:mb-12">
          <Card className="p-5 sm:p-6 bg-card border-border card-glow hover:scale-105 transition-transform">
          ...
          <Card className="p-5 sm:p-6 bg-card border-border card-glow hover:scale-105 transition-transform">
            ...
            <h3 className="text-lg sm:text-xl font-bold mb-2">Leadership</h3>
            <p className="text-muted-foreground text-sm sm:text-base">
          ...
          <Card className="p-5 sm:p-6 bg-card border-border card-glow hover:scale-105 transition-transform sm:col-span-2 md:col-span-1">
            <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mb-4">
        ...
        <Card className="p-5 sm:p-6 md:p-8 lg:p-12 bg-card border-border">
          <div className="space-y-4 md:space-y-6 text-sm sm:text-base md:text-lg leading-relaxed text-foreground/90">
            <p>
