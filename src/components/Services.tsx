      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6">
          {services.map((service, index) => (
            <Card 
              key={index} 
              className="p-5 md:p-6 bg-card border-border card-glow group hover:scale-105 transition-transform"
            >
              ...
              <p className="text-muted-foreground mb-3 md:mb-4 leading-relaxed text-xs sm:text-sm md:text-sm">
                {service.description}
              </p>
              ...
              <div className="flex flex-wrap gap-2">
                {service.tools.map((tool, i) => (
                  <span 
                    key={i}
                    className="px-2.5 py-1 bg-secondary rounded text-xs text-muted-foreground"
                  >
                    {tool}
                  </span>
                ))}
        ...
        <div className="mt-8 md:mt-12 text-center px-2 sm:px-4">
          <Card className="inline-block p-5 md:p-6 bg-gradient-to-r from-primary/10 to-accent/10 border-primary/30 max-w-lg">
